...
def drms_download(start_time, end_time="", time_span="", cadence="", instrument="hmi", data_series="", segments="",
    ...
    if "sharp" in ds_selected:
        download_dir = "/home/lucho/GEHMe/lucho_repo/NF2/test_w_amaia/data_test" + start_time[0:10].replace(".", "") + "/"
    elif "smarp" in ds_selected:
        download_dir = "/home/lucho/GEHMe/lucho_repo/NF2/test_w_amaia/data_test/" + start_time[0:10].replace(".", "") + "/"
    elif "aia.lev1" in ds_selected:
        download_dir = "/home/lucho/GEHMe/lucho_repo/NF2/test_w_amaia/data_test" + wavelength + "/" + start_time[0:10].replace(".", "") + "/"
